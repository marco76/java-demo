...
import { HighlightService } from '../common/highlight/Highlight.service';
...
export class StaticPageComponent implements OnInit, AfterViewChecked {
  ...
  constructor(private requestService: RequestService, private route: ActivatedRoute, private router: Router, private highlightService: HighlightService) {
    ...
    this.routeForPage["javaee-microprofile-config-api"] ="2018-11-14-javaee-microprofile-config-api";
  }
